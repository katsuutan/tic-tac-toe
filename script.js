...
const gameboard = (function () {
    ...
    const placeSymbol = (location, symbol) => {
        ...
        if (symbol === 'O')
            cellImage.setAttribute('src', 'https://raw.githubusercontent.com/katsuutan/tic-tac-toe/main/img/circle.svg');
        else
            cellImage.setAttribute('src', 'https://raw.githubusercontent.com/katsuutan/tic-tac-toe/main/img/cross.svg');
